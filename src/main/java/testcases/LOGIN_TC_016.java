...
public class LOGIN_TC_016 extends TestCase {
	String journey_id;
	ArrayList exceptionList = new ArrayList<>();

	public void setUp() {
		testId = "LOGIN_TC_016";
		testDesc = "To verify user can sign in/up using Truecaller";
	...
	public TestResult test() {
		...
		DummyPage dummyPage = new DummyPage(testContext);
		OkUtil.trueCallerInstallAndOperate(testContext,IXPNEvents.PATH_FOR_TRUECALLER_APK,IXPNEvents.PACKAGE_FOR_TRUECALLER,IXPNEvents.ACTIVITY_FOR_TRUECALLER);
